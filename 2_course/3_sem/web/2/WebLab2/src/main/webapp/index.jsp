...
<header>
    <div class="header-wrapper">
        ...
        <button id="help-toggle" class="help-toggle" aria-label="Показать справку по клавиатурной навигации">
            ?
...
<div id="help-modal" class="modal" role="dialog" aria-modal="true" aria-labelledby="help-title" tabindex="-1">
    <div class="modal-dialog">
        <header class="modal-header">
            <h2 id="help-title">Справка по клавиатурной навигации</h2>
            <button id="help-close" class="modal-close" aria-label="Закрыть справку">×</button>
        </header>
        <div class="modal-content">
            <p>Эта страница поддерживает режим «только клавиатура»</p>
            <h3>Как использовать:</h3>
            <ul>
                <li>Нажмите <kbd>Tab</kbd>, чтобы перемещаться между интерактивными элементами.</li>
                <li>Выберите значения <strong>R</strong> и <strong>X</strong> с помощью стрелок ↑↓.</li>
                <li>Введите значение <strong>Y</strong> с клавиатуры.</li>
                <li>Нажмите <kbd>A</kbd> или <kbd>Ф</kbd>, чтобы переместить фокус на график.</li>
                <li>На графике используйте стрелки ←↑→↓ для перемещения курсора.</li>
                <li>Нажмите <kbd>Enter</kbd>, чтобы отправить текущую точку.</li>
                <li>Нажмите <kbd>Esc</kbd>, чтобы вернуться к выбору параметров.</li>
            </ul>
            <p><strong>Подсказка:</strong> при клавиатурной навигации появляются краткие инструкции внизу формы.</p>
            <p>Нажмите <kbd>Esc</kbd> или кнопку «×» для закрытия этого окна.</p>
        </div>
    </div>
</div>
